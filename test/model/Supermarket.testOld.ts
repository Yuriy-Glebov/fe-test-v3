...
describe('Supermarket', function () {
    ...
    it('buy_two_get_one_free',function (this: any) {
        ...
        theCart.addItem(toothbrush);
        theCart.addItem(toothbrush);
        cashier.addSpecialOffer(SpecialOfferType.ThreeForTwo, toothbrush, catalog.getUnitPrice(toothbrush));
        const receipt = cashier.checksOutArticlesFrom(theCart);
    ...
    it('xForY_discount',function (this: any) {
        ...
        theCart.addItem(cherryTomatoes);
        cashier.addSpecialOffer(SpecialOfferType.TwoForAmount, cherryTomatoes, .99);
        const receipt = cashier.checksOutArticlesFrom(theCart);
        expect(receipt.getDiscounts()).lengthOf(1)
